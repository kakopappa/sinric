...
def getJSON(deviceId, value):
    temp = OrderedDict([('deviceId', deviceId), ('action', 'setPowerState'),
                        ('value', value)])  # Used OrderedDict function because dict() alerts the input json
...
if __name__ == "__main__":
    ...
    ws = websocket.create_connection('ws://iot.sinric.com',
                                     header={'Authorization:' + base64.b64encode('apikey:' + apiKey)})
